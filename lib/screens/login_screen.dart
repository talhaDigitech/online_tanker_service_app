              ...
              Form(
                ...
                onPressed: () {
                  if (formKey.currentState!.validate()) {
                    ...
                    print('Login Successful: ${phoneController.text}');
                    _handleLogin();
  ...
  Widget _buildCountryCodeContainer() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Colors.grey[300]!),  // Added border to match TextField
      ),
      child: Row(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: _buildInputBorder(
              phoneController.text.length == 11 ? Colors.green : Colors.grey[300]!
            ),
